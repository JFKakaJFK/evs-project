...
public class UserServiceTest {
    ...
    public void testDatainitialization() {
        ...
        for (User user : userService.getAllUsers()) {
            if ("admin".equals(user.getUsername())) {
                ...
                Assert.assertTrue("User \"user1\" does not have role MANAGER", user.getRoles().contains(UserRole.EMPLOYEE));
                ...
                Assert.assertTrue("User \"user2\" does not have role EMPLOYEE", user.getRoles().contains(UserRole.STUDENT));
    ...
    public void testCreateUser() {
        ...
        toBeCreatedUser.setRoles(Sets.newSet(UserRole.EMPLOYEE, UserRole.EMPLOYEE));
